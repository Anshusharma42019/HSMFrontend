...
export default function Invoice() {
  ...
  const getOrGenerateInvoiceNumber = async (orderId, prefix) => {
    ...
    const invoiceNumber = `XT/${month}/${sequence}`;
    localStorage.setItem(storageKey, invoiceNumber);
    ...
    try {
      ...
      if (bookingData && (bookingData.tableNo || bookingData.staffName)) {
        ...
        if (mappedData.invoiceDetails) {
          ...
          const billNo = bookingData?.invoiceNumber || await getOrGenerateInvoiceNumber(checkoutId, 'XT');
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-4 space-y-4 lg:space-y-0">
              <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
                <div className="w-20 h-20 sm:w-24 sm:h-24">
                  <img src={ashokaLogo} alt="XLUX TECH Logo" className="w-full h-full object-contain" />
                </div>
                <div className="text-xs text-center sm:text-left">
                  <p className="font-bold text-sm sm:text-base">HOTEL XLUX TECH </p>
                  ...
                  <p className="text-xs">Website: <a href="https://hotelXLUX TECH.com" className="text-blue-600">hotelXLUX TECH.com</a></p>
                  <p className="text-xs">contact@hotelXLUX TECH.in</p>
              ...
              <div className="contact-info flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4">
                ...
                <div className="text-xs flex items-center space-x-2">
                    ...
                    <span>contact@hotelXLUX TECH.in</span>
                </div>
              </div>
            </div>
