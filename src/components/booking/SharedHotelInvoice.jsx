            ...
            <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
              <div className="border border-black p-2">
                <div className="w-16 h-16 sm:w-20 sm:h-20">
                  <img src={ashokaLogo} alt="XLUX TECH Logo" className="w-full h-full object-cover" />
                </div>
              </div>
              <div className="text-xs text-center sm:text-left">
                <p className="font-bold text-sm sm:text-base">XLUX TECH HOTEL</p>
                ...
                <p className="text-xs">Website: <a href="http://XLUX TECH-hotel.com" className="text-blue-600">XLUX TECH-hotel.com</a></p>
